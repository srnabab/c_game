...
extern void SDLCALL createFrameBuffer(uint32_t imageCount, Uint32 width, Uint32 height, Uint32 attachmentCount, VkImageView * pImageViews, VkImageView * pSwapchainImageView, VkRenderPass * pRenderPass, VkFramebuffer ** pSwapchainFramebuffer);
