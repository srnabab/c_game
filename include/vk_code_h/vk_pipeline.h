...
extern bool SDLCALL addComputePipeline(VkPipelineShaderStageCreateInfo * pShaderStageCreateInfo, VkPipelineLayout * pComputePipelineLayout, VkPipeline basePipelineHandle, Uint32 basePipelineIndex, VkPipeline * pComputePipeline);
