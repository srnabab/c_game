...
extern VkResult SDLCALL copyBuffer(VkCommandBuffer commandBuffer, VkCommandPool commandPool, VkBuffer * pSrcBuffer, VkBuffer * pDstBuffer, VkDeviceSize size);
extern void SDLCALL releaseBufferFromQueue(VkCommandPool commandPool, VkAccessFlags srcAccessMask, VkPipelineStageFlags srcStageFlags, Uint32 srcQueueFamilyIndice, Uint32 dstQueueFamilyIndice, VkBuffer buffer, VkDeviceSize bufferSize);
