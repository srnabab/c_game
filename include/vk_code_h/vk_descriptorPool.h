...
extern bool SDLCALL G_createDescriptorSets(VkDescriptorPool * pDescriptorPool, VkDescriptorSetLayout * pDescriptorSetLayout, Uint32 shaderSetCount, Uint32 SetsCount, G_DescriptorSets * pDescriptorSets);
