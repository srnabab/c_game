...
extern void SDLCALL updateGraphicDescriptorSets(VkDevice * pDevice, VkBuffer ** ppUniformBuffers, VkDescriptorSet ** ppDescriptorSets, Uint32 imageViewCount, VkImageView * pTextureImageView, VkSampler * pTextureSampler);
