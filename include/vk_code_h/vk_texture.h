...
extern VkResult SDLCALL copyBufferToImage(VkCommandBuffer commandBuffer, VkImage * pImage, Uint32 width, Uint32 height, VkBuffer * pBuffer, VkDeviceSize bufferOffset);
