...
uint32_t getBestPhysicalDeviceIndex(VkPhysicalDevice *pPhysicalDevices, uint32_t physicalDeviceNumber){
	...
	printf("max uniform buffers: %u, max storage buffers: %u\n", physicalDeviceProperties->limits.maxDescriptorSetUniformBuffers, physicalDeviceProperties->limits.maxDescriptorSetStorageBuffers);
