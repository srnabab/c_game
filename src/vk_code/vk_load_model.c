...
, const char * innerName, G_DescriptorSets * pDescriptorSet, void * data)
{
    ...
    bool textureRes = G_loadImage(texturePath, textureFormat, flags, innerName, pDescriptorSet, 0, data);
