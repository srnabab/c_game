...
void addDescriptorSetLayout(VkDevice * pDevice, uint32_t bindingCount, VkDescriptorSetLayoutBinding * pBindings, uint32_t set, VkDescriptorSetLayout ** ppDescriptorSetLayout)
{
    ...
    *ppDescriptorSetLayout = (VkDescriptorSetLayout *)realloc(*ppDescriptorSetLayout, (set + 1) * sizeof(VkDescriptorSetLayout));
    ...
    resultVulkan(vkCreateDescriptorSetLayout(*pDevice, &layoutInfo, VK_NULL_HANDLE, &(*ppDescriptorSetLayout)[set]), createDescriptorSetLayoutF, 0);
}
...
void createDescriptorPool(VkDevice * pDevice, uint32_t poolSizeCount, VkDescriptorPoolSize * pPoolSizes, uint32_t maxSets, VkDescriptorPool * pDescriptorPool)
{
    ...
    resultVulkan(vkCreateDescriptorPool(*pDevice, &poolInfo, VK_NULL_HANDLE, pDescriptorPool), code, 0);
}
...
void createGraphicDescriptorSets(VkDevice * pDevice, VkBuffer ** ppUniformBuffers, VkDescriptorSetLayout * pDescriptorLayout, VkDescriptorPool * pDescriptorPool, VkDescriptorSet ** ppDescriptorSets, VkImageView * pTextureImageView, VkSampler * pTextureSampler)
{
    ...
    *ppDescriptorSets = (VkDescriptorSet *)calloc(MAX_FRAMES_IN_FLIGHT ,sizeof(VkDescriptorSet));
    ...
    for (int i = 0;i < MAX_FRAMES_IN_FLIGHT;i++)
    {
        ...
        descriptorWrite[0].pNext = VK_NULL_HANDLE;
        ...
        imageInfo.imageView = *pTextureImageView;
        imageInfo.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;

        descriptorWrite[1].sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
        descriptorWrite[1].pNext = VK_NULL_HANDLE;
        ...
        descriptorWrite[1].pBufferInfo = VK_NULL_HANDLE;
        descriptorWrite[1].pTexelBufferView = VK_NULL_HANDLE;

        vkUpdateDescriptorSets(*pDevice, 2, descriptorWrite, 0, VK_NULL_HANDLE);
    }
}
void createParticleDescriptorSets(VkDevice * pDevice, VkBuffer ** ppUniformBuffers, VkDescriptorSetLayout * pDescriptorLayout, VkDescriptorPool * pDescriptorPool, VkDescriptorSet ** ppDescriptorSets)
{
    ...
    *ppDescriptorSets = (VkDescriptorSet *)calloc(MAX_FRAMES_IN_FLIGHT, sizeof(VkDescriptorSet));
    ...
    for (int i = 0;i < MAX_FRAMES_IN_FLIGHT;i++)
    {
        ...
        vkUpdateDescriptorSets(*pDevice, 1, descriptorWrite, 0, VK_NULL_HANDLE);
    }
}
void createComputeDescriptorSets(VkDevice * pDevice, VkBuffer ** ppUniformBuffers, VkBuffer ** ppShaderStorageBuffers, VkDescriptorSetLayout * pDescriptorLayout, VkDescriptorPool * pDescriptorPool, VkDescriptorSet ** ppDescriptorSets)
{
    ...
    *ppDescriptorSets = (VkDescriptorSet *)calloc(2, sizeof(VkDescriptorSet));
    ...
    for (int i = 0;i < MAX_FRAMES_IN_FLIGHT;i++)
    {
        ...
        descriptorWrite[1].descriptorCount = 1;
        descriptorWrite[1].pImageInfo = VK_NULL_HANDLE;
        ...
        descriptorWrite[2].pNext = VK_NULL_HANDLE;
        ...
        descriptorWrite[2].pImageInfo = VK_NULL_HANDLE;
        descriptorWrite[2].pBufferInfo = &storageBufferInfoCurrentFrame;
        descriptorWrite[2].pTexelBufferView = VK_NULL_HANDLE;

        vkUpdateDescriptorSets(*pDevice, 3, descriptorWrite, 0, VK_NULL_HANDLE);
    }
}